...
const Testimonials = () => {
    ...
    return (
        <section className="py-16 lg:py-20 bg-gray-50 dark:bg-gray-900 transition-colors duration-300 relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                <div className="max-w-5xl mx-auto">
                    <div className="bg-white dark:bg-gray-800 rounded-2xl lg:rounded-3xl p-8 lg:p-12 shadow-xl dark:shadow-gray-900/20 relative">
                        {/* Quote Icon */}
